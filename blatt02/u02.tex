...
\begin{exercise}{5}
	...
	\begin{figure}[H]
		\centering
  		\scalebox{.8}{\includegraphics{2_2nrzi-m.pdf}}
	\end{figure}
	Unipolar RZ:
	\begin{figure}[H]
		\centering
  		\scalebox{.8}{\includegraphics{2_2unipolar-rz.pdf}}
	\end{figure}
	Manchester:
	\begin{figure}[H]
		\centering
  		\scalebox{.8}{\includegraphics{2_2manchester.pdf}}
	\end{figure}
	Biphase-M:
	\begin{figure}[H]
		\centering
  		\scalebox{.8}{\includegraphics{2_2biphase-m.pdf}}
	\end{figure}
	RZ:
	\begin{figure}[H]
		\centering
  		\scalebox{.8}{\includegraphics{2_2rz.pdf}}
	\end{figure}
	NRZ-L:
	\begin{figure}[H]
		\centering
  		\scalebox{.8}{\includegraphics{2_2nrz-l.pdf}}
	\end{figure}\ \\
	\end{subexercise}
	...
	\begin{figure}[H]
		\centering
  		\scalebox{.8}{\includegraphics{2_2b.pdf}}
	\end{figure}
	\end{subexercise}
